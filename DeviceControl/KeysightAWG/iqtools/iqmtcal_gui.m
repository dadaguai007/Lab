...
try
    ...
    elseif (~isempty(strfind(arbConfig.model, 'M8195A_2ch')))
...
if (get(handles.radiobuttonRTScope, 'Value') == 1)
    ...
    if (rtsConn)
        ...
        set(handles.popupmenuIScope, 'String', {'1', '2', '3', '4', 'DIFF1', 'DIFF2', 'REdge1', 'REdge3'});
...
if (get(handles.radiobuttonDCA, 'Value') == 1)
    ...
    if (isfield(arbConfig, 'isDCAConnected') && arbConfig.isDCAConnected)
        ...
        set(handles.radiobuttonRTScope, 'Value', 0);
        set(handles.popupmenuIScope, 'String', {'1A', '1B', 'DIFF1A', '1C', '1D', 'DIFF1C', '2A', '2B', '2C', '2D', '3A', '3B', 'DIFF3A', '3C', '3D', 'DIFF3C', '4A', '4B', '4C', '4D'});
        set(handles.popupmenuQScope, 'String', {'1A', '1B', 'DIFF1A', '1C', '1D', 'DIFF1C', '2A', '2B', '2C', '2D', '3A', '3B', 'DIFF3A', '3C', '3D', 'DIFF3C', '4A', '4B', '4C', '4D', 'unused'});
...
if ((strncmpi(hs{4}, 'REdge', 5) || strncmpi(hs{5}, 'REdge', 5)) && ~strcmp(hs{6}, 'AUX'))
    hx(6) = 1;
end
...
try
    ...
    figs = findobj(0, 'Type', 'figure', 'Name', 'Pre-distortion Management');
