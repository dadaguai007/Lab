...
% Last Modified by GUIDE v2.5 30-Jan-2015 11:28:29
...
useGlobalCorr = 0;
set(handles.textAmplScale, 'Visible', onoff{2 - useGlobalCorr});
set(handles.popupmenuAmplScale, 'Visible', onoff{2 - useGlobalCorr});
set(handles.editAmplScale, 'Visible', onoff{2 - useGlobalCorr});
set(handles.textCarrierFreq, 'Visible', onoff{2 - useGlobalCorr});
set(handles.editCarrierFreq, 'Visible', onoff{2 - useGlobalCorr});
set(handles.checkboxSetCarrierFreq, 'Visible', onoff{2 - useGlobalCorr});
set(handles.checkboxM8195Acorr, 'Visible', onoff{1 + useGlobalCorr});
if (~useGlobalCorr)
...
% trigger and few others are only implemented for M8190A (so far)
if (~isempty(strfind(arbModel, 'M8190A')))
    ...
    set(handles.checkboxExtClk, 'Enable', 'on');
    set(handles.textExtClk, 'Enable', 'on');
else
    ...
    set(handles.checkboxExtClk, 'Enable', 'off');
    set(handles.textExtClk, 'Enable', 'off');
end
